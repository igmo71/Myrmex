...
For active feature work, resolve the current feature through `.specify/feature.json` and start with its `plan.md` and `tasks.md` when it exists. Read other feature artifacts only when directly relevant.
